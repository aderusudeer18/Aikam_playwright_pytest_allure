from pages.select_job_to_delete_job.login_page import LoginPage
from pages.select_job_to_delete_job.dashboard_page import DashboardPage 
from pages.select_job_to_delete_job.jobs_page import JobsPage
from pages.select_job_to_delete_job.view_applicant_page import ViewJob
from pages.select_job_to_delete_job.all_applicant_page import AllApplicant
...
def test_login_valid_credtionals(page):
    ...
    applicant_page.advance_filters("Flipkart","Google","GTM","ramprasads444@gmail.com")
