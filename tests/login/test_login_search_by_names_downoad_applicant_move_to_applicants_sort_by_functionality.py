...
def test_login_valid_credtionals(page):
    ...
    login.login("kiyeg97091@jobraux.com", "Vj#7&vh9KNIUia$5") 
    ...
    job_page.wait_until_jobs_page("JOB0001","Java Developer") 
    view_btn=ViewJob(page)
    view_btn.view_job() 


    applicant_page=AllApplicant(page)
    applicant_page.search_by_name("KOLUSU LAKSHMI PRASANNA") 
    applicant_page.all_applicant_page("KOLUSU LAKSHMI PRASANNA")
    applicant_page.download_excel_btn()

    applicant_page.all_applicant_pre_screened("KOLUSU LAKSHMI PRASANNA")
    applicant_page.move_to_applicant_pre_screened("KOLUSU LAKSHMI PRASANNA")


    applicant_page.search_by_name("Mohammed Imran")
    applicant_page.all_applicant_shortlisted("Mohammed Imran")
    ...
    applicant_page.all_applicant_selected("Jalandhar Bhoi")
    applicant_page.move_to_applicant_selected()
    
    applicant_page.search_by_name("Jaya Bhargava Kotturu")
    applicant_page.all_applicant_rejected("Jaya Bhargava Kotturu")
